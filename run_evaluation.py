...
def run_evaluation():
    ...
    parser.add_argument("--test_path", type=str, default="/datasets/LCC_FASD/LCC_FASD/LCC_FASD_evaluation")
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--modelname", type=str, default="seresnext50")
    parser.add_argument("--model_checkpoint", type=str, default="/checkpoint/seresnext50.ckpt")
